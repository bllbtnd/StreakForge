...
pub fn render_error_card(message: &str) -> String {
  ...
  <text x="200" y="90" text-anchor="middle" font="bold 18px system-ui, monospace" fill="#f85149">⚠ Error</text>
  <text x="200" y="118" text-anchor="middle" font="13px system-ui, monospace" fill="#8b949e">{message}</text>
</svg>"#,
...
fn flame_svg(streak: i64) -> String {
    let (height, color, anim_class) = match streak {
        0..=6 => (18, "#e3b341", ""),
        7..=29 => (22, "#f0883e", r#" class="flicker-gentle""#),
        30..=99 => (26, "#ff6b35", r#" class="flicker-active""#),
        _ => (30, "#ff4444", r#" class="flicker-intense""#),
    };
    let y = 24 - height;
    format!(
        r#"<g transform="translate(14,{})" {anim_class}>
